                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" class="form-control" required readonly name="InvoiceNo" id="InvoiceNo" value="{{$invoice[0]->invoice}}">
                                </div>
                                <div class="form-group col-lg-2">
                                ...
                                <table id="product_info_table" class="table table-bordered">
                                    ...
                                    <tbody id="tbody">
                                        <tr> 
                                            ...
                                            <td>
                                                 <select id="unit_1" name="unit[]" class="form-control" required>
                                                    <option disabled selected >Select Unit</option> 
                                                    @foreach($Units as $v)
                                                    <option value="{{$v->id}}">{{$v->unit_code}}</option> 
                                                    @endforeach                                 
                                                </select>
                                            </td>
                                             <td>
      ...
      var row_id = count_table_tbody_tr + 1;
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    ...
                    '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="unit_'+row_id+'" name="unit[]" style="width:100%;" onchange="getProductInfo('+row_id+')">'+
